import { Fade,Box, Button, Card, CardActions, CardContent, CardMedia, Grid, Paper, Typography } from '@material-ui/core'
...
<div className={classes.buttonsField}>
    <div className={classes.buttons}><span className={classes.gitSpace}>
